    ...
    <Box width={"100%"}>
      <Box px={2} py={6} className={classes.top} position={"relative"}>
        ...
        <ThemeProvider theme={darkTheme}>
          ...
          >
            <Item>
              <Typography className={classes.newsletterText}></Typography>
            </Item>
            <Item>
              <EmailSubscribe
        ...
        <Container disableGutters>
          <Grid container spacing={4}>
            <Grid item xs={12} md={4} lg={3}>
              ...
              <Typography className={classes.info}>admin@arc.fake</Typography>
            </Grid>
        ...
        <Container disableGutters>
          ...
          >
            <Item grow ml={-2} shrink={0}>
              <NavMenu useStyles={usePlainNavigationMenuStyles}></NavMenu>
            </Item>
            <Item>
